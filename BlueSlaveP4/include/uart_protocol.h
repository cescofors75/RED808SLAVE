...
#define ENC_REVERB      0x01    // DFRobot encoder #1 — Reverb mix 0-127
#define ENC_PHASER      0x02    // DFRobot encoder #2 — Phaser mix 0-127
...
#define FX_ENC1_MUTE    0x01    // Encoder 1 (Reverb) mute:  value 0/1
#define FX_ENC2_MUTE    0x02    // Encoder 2 (Phaser) mute:  value 0/1
